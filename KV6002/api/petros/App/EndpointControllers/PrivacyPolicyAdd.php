...
/**
 * Endpoint PrivacyPolicyAdd.
 * 
 * This endpoint handles the POST request to update the text on the Privacy Policy page.
 * 
 * @author Petros Tamboutsiaris W21004471
 */

class PrivacyPolicyAdd extends Endpoint
{
    /**
    ...
    /**
     * The SQL query to update the text on the Privacy Policy page.
     */
    private $sql = "UPDATE privacyPolicyText SET text = :text"; 
    private $sqlParams = [];

    /**
     * Constructor of the PrivacyPolicyAdd endpoint.
     * 
     * Handles the POST request to update the text on the Privacy Policy page.
     * 
