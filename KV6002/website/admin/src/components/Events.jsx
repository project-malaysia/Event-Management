...
function Events() {
    ...
    if ((contentStatus === 'all' || contentStatus === 'kuala lumpur' || contentStatus === 'johor bahru' || contentStatus === 'malacca city' || contentStatus === 'kuching' || contentStatus === 'ipoh' || contentStatus === 'george town' || contentStatus === 'kuala terengganu' || contentStatus === 'petaling jaya') && (searchContent.length === 0)) {
            ...
            return (
                <section key={index} onClick={() => handleEventClick(item)}>
                    ...
                    <div className="flex flex-col items-center justify-center">
                        <Link to={"/events/delete-event/" + item.event_id} className="text-blue-500">
                            <button className="mt-2 bg-red-600 hover:bg-red-500 text-white font-bold py-2 px-4 rounded">
                                Delete Event
                            </button>
                        </Link>
                    </div>
        ...
        <div className="bg-purple-200 dark:bg-gray-800 flex flex-col min-h-screen">
            <div className="flex-grow">
                ...
                <div className="mt-4 mb-8 flex justify-center items-center">
                    <Link to="/events/add-event/" className="text-blue-500">
