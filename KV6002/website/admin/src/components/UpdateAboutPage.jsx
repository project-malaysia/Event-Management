...
function UpdateAboutPage() {
    ...
    function updateText() {
        ...
        fetch("https://w21004471.nuwebspace.co.uk/kv6002/api/homepage/add", {
            method: 'POST',
            body: formData
        })
            .then((response) => {
                ...
                alert('About page has been updated successfully. Please go back to see the updated text.');
            })
            .catch((error) => {
                console.error('Error reason:', error);
            });
            ...
            return (
                <div className="bg-purple-200 dark:bg-gray-800 flex justify-center items-center" style={{ minHeight: 'calc(99vh - 4rem)' }}>
                    <div className="max-w-md mx-auto p-6 bg-pink-200 border-2 border border-gray-900 dark:bg-gray-700 rounded-md dark:border-white">
                        <p className="mb-2 text-center font-bold">Are you sure you want to update About page?</p>
                ...
                <div className="bg-purple-200 dark:bg-gray-800" style={{ minHeight: 'calc(99vh - 4rem)' }}>
                    <div style={{ marginTop: 0, paddingTop: 30 }}>
                        <div className="text-center">
                            <h1 className="text-3xl font-bold">Update the text on the <span className="text-pink-600 dark:text-pink-400">About Page</span></h1>
                        </div>
                        <div className="max-w-3xl mx-auto mt-4 p-4">
                            ...
                            <div >
                                <div className="flex justify-center mt-4">
                                    <Link to="/about" className="px-4 py-2 bg-purple-600 text-white font-bold rounded-md hover:bg-purple-800 mr-2">
                                        Back
                                    </Link>
                                    <button
