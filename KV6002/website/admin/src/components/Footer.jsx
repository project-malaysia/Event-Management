            ...
            <div className="container mx-auto flex flex-col md:flex-row justify-between items-center">
                ...
                <div className="flex flex-col md:flex-row justify-end md:justify-start items-center md:items-start">
                    <div className="flex flex-col items-center md:items-start mb-4 md:mb-0 mr-12">
                        ...
                        <Link to="/Administrator" className="mx-6 text-blue-200 hover:underline mb-2 dark:text-blue-500" onClick={scrollToTop}>Events</Link>
                        <Link to="/calendar" className="mx-6 text-blue-200 hover:underline mb-2 dark:text-blue-500" onClick={scrollToTop}>Calendar</Link>
                        <Link to="/forum" className="mx-6 text-blue-200 hover:underline mb-2 dark:text-blue-500" onClick={scrollToTop}>Community & Forum</Link>
                        <Link to="/signin" className="mx-6 text-blue-200 hover:underline dark:text-blue-500" onClick={scrollToTop}>Sign In</Link>
                    </div>
                    {/* Legal Links Section */}
                    ...
                    <div className="flex flex-col">
                        ...
                        <nav className="flex space-x-4">
                            ...
                            <a href="https://www.facebook.com/profile.php?id=61557499756419" className="text-blue-200 hover:underline dark:text-blue-500" target="_blank" rel="noopener noreferrer">Facebook</a>
