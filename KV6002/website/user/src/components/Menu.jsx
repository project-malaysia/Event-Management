        ...
        <div className="menu bg-purple-900 text-white dark:bg-black">
            <div className="flex items-center">
                ...
                <ul className="list-none flex space-x-4 p-4">
                    ...
                    {token && <button onClick={handleSignOut} className="text-xl font-bold transition duration-300 ease-in-out transform hover:scale-110 hover:bg-white hover:text-black px-4 py-2 rounded-md">
                        Sign Out
                    </button>}
                </ul>
            </div>
